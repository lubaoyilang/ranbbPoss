...
app = angular.module("app", ["ngSanitize","ngAnimate","ui.router", "ui.bootstrap","ui.bootstrap.datetimepicker","ui.select","checklist-model","datatables","datatables.bootstrap","datatables.scroller","ngToast","infinite-scroll","chart.js","ng-sidr"]).run([
  ...
  .state('main.projects.editGoods', {
    url: '/editGoods',
    templateUrl: 'templates/controllers/projects/EditGoods.html',
  ...
  .state('main.projects.orderList', {
    url: '/orderList',
    templateUrl: 'templates/controllers/orders/orderList.html',
    controller: 'OrderListController'
  })
  .state('main.wallet', {
    url: '/wallet',
    templateUrl: 'templates/controllers/wallet/wallet.html',
