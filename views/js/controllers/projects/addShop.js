 ...
 * Created by wangmeng on 16/1/23.
 */
angular.module("app").controller('AddShopController', ['$scope','$modal','$timeout','$state','$http','ngToast','$rootScope',function($scope,$modal,$timeout,$state,$http,ngToast,$rootScope) {
